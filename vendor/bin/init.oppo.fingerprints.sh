...
chown system system /sys/bus/platform/devices/soc/soc\:fpc_interrupt/regulator_disable
...
chmod 0200 /sys/bus/platform/devices/soc/soc\:fpc_interrupt/regulator_disable
